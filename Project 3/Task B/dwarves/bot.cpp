...
int col_fence;
/*
This function will direct the dwarves to build a defensive structure of the
following shape:
01234567
######## 8 0
##    ## 4 1
...
######## 8 6
       = 30 total fences
*/
void buildFence(Dwarf &dwarf){
  if(row_fence == 0){
    if(col_fence <= 7){
      dwarf.start_walk(row_fence + 1, col_fence);
